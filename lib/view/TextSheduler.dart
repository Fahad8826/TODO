...
//         // If we have minutes (from HH:MM format)
...
//     // If the resulting time is in the past, move it to tomorrow
...
//           context, MaterialPageRoute(builder: (context) => Dummyhomepage()));
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
...
//         Color.fromARGB(255, 237, 237, 205); // Light sand color
...
//                         ),
//                       ),
//                       // Task input area styled like a chat message
//                       // ... previous code remains the same until the Container section ...
...
//                       // Action buttons in chat-like style
//                       Row(
//                         children: [
//                           Expanded(
